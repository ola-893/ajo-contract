...
const AjoDetails = () => {
  ...
  const [cycleStartTime, setCycleStartTime] = useState<number | undefined>();
  ...
  const { getCycleStartTime } = useStarknetAjoPayments(
    ajoInfo?.paymentsAddress || "",
  );
