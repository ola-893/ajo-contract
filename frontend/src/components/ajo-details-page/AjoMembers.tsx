      ...
      <div className='bg-card rounded-xl shadow-lg p-4 sm:p-6 border border-border'>
        ...
        {memberRows.length === 0 ? (
          <div className='text-center py-8 text-muted-foreground'>
            ...
            <p className='text-sm'>Members will appear once they join this Ajo</p>
          </div>
        ) : (
                ...
                <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-3'>
                  ...
                  <div className='flex flex-wrap items-center gap-2'>
                    ...
                    <span className='text-xs px-2 py-1 rounded border border-border text-muted-foreground'>
                      Collateral:{' '}
                      {formatTokenAmount(member.collateralDeposited, tokenDecimals)}
                    </span>
                    <span className='text-xs px-2 py-1 rounded border border-border text-muted-foreground'>
                      Payout: {member.hasReceivedPayout ? 'Received' : 'Pending'}
                    </span>
                    <span className='text-xs px-2 py-1 rounded border border-border text-muted-foreground'>
                      Cycle {currentCycle}:{' '}
